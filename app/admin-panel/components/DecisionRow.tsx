  ...
  return (
    ...
    >
      <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
        <AdCreativeThumb
          imageUrl={decision.creative_image_url}
          videoUrl={decision.creative_video_url}
          alt={decision.ad_name}
          href={decision.client_id ? `/app/clients/${decision.client_id}/ads/${decision.ad_id}` : null}
        />
