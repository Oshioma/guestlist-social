...
/**
 * The whole configuration read-out, rendered inside the super-admin System
 * tab. It lives here rather than on its own route because two places to look
 * is exactly how the first pair of status pages drifted apart.
 */
export default async function SystemsReport() {
