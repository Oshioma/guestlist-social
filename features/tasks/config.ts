// Default configuration for the portable tasks module.
//
// Host apps can import these defaults or supply their own. Categories in
// particular are expected to be overridden per project.
